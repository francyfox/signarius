export const works = [
  {
    ...
    bio:
      ...
      "страницы, переписал функционал магазина с jquery на native js. Пожелание от клиента, сделать реализацию корзины " +
  ...
  },
  {
    ...
    bio:
      "Переверстка шапки, подвала, страницы товара. Адаптация некоторых секций, поиск городов " +
